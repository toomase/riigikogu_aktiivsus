...
riigikogu_liikmete_aktiivsus %>% 
  ...
  annotate("text", x = mediaan_aktiivsus$suuliselt, y = 650, 
           hjust = -0.1, label = str_c("mediaan ", mediaan_aktiivsus$suuliselt), 
           size = 5) +
  annotate("text", x = 1200, y = mediaan_aktiivsus$kirjalikult, 
           vjust = -1, label = str_c("mediaan ", mediaan_aktiivsus$kirjalikult), 
           size = 5) +
  theme_ipsum_rc() +
